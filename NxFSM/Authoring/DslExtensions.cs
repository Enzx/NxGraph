...
public static partial class DslExtensions
{
    ...
    public static ThenElseBuilder Then(this IfBuilder ifBuilder, Func<CancellationToken, ValueTask<Result>> run)
    {
        ArgumentNullException.ThrowIfNull(run);
    ...
    public static TerminalBuilder Else(this ThenElseBuilder ifBuilder, Func<CancellationToken, ValueTask<Result>> run)
    {
        ArgumentNullException.ThrowIfNull(run);
        RelayState relay = new(run);
